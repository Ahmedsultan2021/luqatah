                      ...
                      <div>
                        <b-button-group>
                          ...
                          <div v-if="$route.query.Type === 'lost' || $route.query.Type === 'found'">
                            <b-button v-if="announcement.bookmark" @click="bookmark_announcement"  variant="link" class="text-secondary" size="md">
                              <BookmarkIcon/>
                              <span class="ml-2">Unbookmark</span>
                            </b-button>
                            <b-button v-else  @click="bookmark_announcement" variant="link" class="text-secondary" size="md">
                              <BookmarkIcon/>
                ...
                <b-card class="my-2">
                  <b-card-title>
                    <div class="d-flex justify-content-between" v-if="currentUser.id == announcement.user.id">
                      <p></p>
                      <b-button v-if="readOnly" @click="readOnly =!readOnly" variant="link" class="text-secondary">
                        <Edit2Icon/> Edit
                      </b-button>
                  ...
                  >
                    ...
                    >
                      <b-form-input style="font-weight: bold; font-size:17px" autocomplete="off" class="text-center text-light bg-dark" disabled v-model="ann_type" readonly id="nested-street"></b-form-input>
                    </b-form-group>
                    <b-form-group
                      ...
                      label-align-sm="right"
                    >
                      <b-form-input style="font-weight: bold; font-size:15px" autocomplete="off" class="text-center text-primary" v-model="announcement.title" :readonly="readOnly" id="nested-city"></b-form-input>
                    </b-form-group>
                    <b-form-group
                      label="Date From:"
                      ...
                      label-align-sm="right"
                    >
                      <b-form-input type="date" style="font-weight: bold; font-size:15px" autocomplete="off" class="text-center text-primary" v-model="announcement.start_date" :readonly="readOnly" id="nested-state"></b-form-input>
                    </b-form-group>
                    <b-form-group
                      label="Date To:"
                      ...
                      label-align-sm="right"
                    >
                      <b-form-input type="date" style="font-weight: bold; font-size:15px" autocomplete="off" class="text-center text-primary" v-model="announcement.end_data" :readonly="readOnly" id="nested-country"></b-form-input>
                    </b-form-group>
                  </b-form-group>
                 <div class="text-right">
                  <b-button size="md" variant="secondary" v-if="!readOnly" @click="save_general_changes">save changes</b-button>
                 </div>
                 <b-row class="mt-5" v-if="announcement.locations.length > 0">
                    ...
                    <b-col cols="12" lg="5" md="5" sm="12">
                      <b-list-group class="px-1"  v-for="(marker, index) in announcement.locations" :key="index">
                  ...
                  >
                    <div  v-for="(item, itemIndex) in announcement.items" :key="itemIndex">
                      ...
                      ></b-form-group>
                     <div v-for="(category, categoryIndex) in item.lost_sub_category" :key="categoryIndex">
                      <b-form-group
                        ...
                        class="mb-2"
                      >
                        <b-form-select style="font-weight: bold; font-size:15px"  
                      ...
                      <b-form-group
                        ...
                        v-if="category.sub_category"
                      >
                       <b-form-input v-if="isDisabled" class="text-center" style="font-weight: bold; font-size:15px" v-model="category.sub_category.title" :disabled="isDisabled"></b-form-input>
                      <div v-else>
                        <b-form-select v-if="subcategories.length > 0" style="font-weight: bold; font-size:15px"  
                          class="text-center text-primary" 
                        ...
                        ></b-form-select> 
                        <div class="text-right">
                          <b-button class="mt-3" size="sm" variant="secondary" v-if="!isDisabled" @click="save_updated_category(category)">save changes</b-button>
                        </div>
                      </div>
                      </b-form-group>
                     </div>
                     ...
                     v-if="item.additional_data.length > 0"
                      ...
                      ></b-form-group>
                     <div v-for="(additional, additionalIndex) in item.additional_data" :key="additionalIndex">
                      <b-form-group
                        label="Name (Arabic):" label-for="nested-city"
                        label-cols-sm="3" label-align-sm="right"
                        v-if="additional.name_ar"
                      >
                       <b-form-input style="direction: rtl;" readonly v-model="additional.name_ar"></b-form-input>
                      </b-form-group>
                      <b-form-group
                        label="Name (Latin):" label-for="nested-city"
                        label-cols-sm="3" label-align-sm="right"
                      ...
                      <b-form-group
                        label="Number:" label-for="nested-city"
                        label-cols-sm="3" label-align-sm="right"
                      ...
                      <b-form-group
                        label="Model:" label-for="nested-city"
                        label-cols-sm="3" label-align-sm="right"
...
export default {
  ...
  methods: {
    ...
    addMarker(newLocation) {
       ...
       this.announcement.line_string.coordinates.push([newLocation.longitude, newLocation.latitude]);
     },
    ...
    bookmark_announcement(){
      ...
      if(this.$route.query.Type === 'found'){
        axios.post('user/found/bookmark' , {
